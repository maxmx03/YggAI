...
local combat = Selector {
  ...
  Condition(Unless(castPoisonMist, enemyNodes.isPoisonType), enemyNodes.hasEnemyGroup(2, 5)),
  Condition(Unless(castToxinOfMandara, enemyNodes.isPoisonType), enemyNodes.hasEnemyGroup(2, 5)),
